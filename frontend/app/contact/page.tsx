...
const heroStats = [
  { label: "Resposta", value: "< 24h", note: "Dias uteis" },
  { label: "Kickoff", value: "5 dias", note: "Apos alinhamento" },
  { label: "Canal", value: "Slack/Meet", note: "Direto" },
];

const contactSignals = [
  { label: "Localizacao", value: "Portugal" },
  { label: "Fuso", value: "GMT" },
  { label: "Disponibilidade", value: "09:00 - 18:00" },
];
    ...
    <div className="relative">
      <PageHero
        ...
        title={
          <>
            Vamos falar
            <span className="block text-[color:var(--accent)]">do teu projeto.</span>
          </>
        }
        description="Diz-nos o contexto, objetivo e prazo. Respondemos com proposta e proximos passos."
        meta={["Portugal", "Remote", "Resposta rapida"]}
            ...
            <AnimatedSection className="space-y-6">
              ...
              <Card className="bg-white/[0.03]">
                ...
                <ul className="space-y-3 text-sm text-white/60">
                  ...
                  <li className="flex items-center gap-2">
                    <span className="h-1.5 w-1.5 rounded-full bg-[color:var(--accent)]" />
                    Proposta com prazos e investimento.
                  </li>
                  <li className="flex items-center gap-2">
                    <span className="h-1.5 w-1.5 rounded-full bg-[color:var(--accent)]" />
                    Plano de 6 semanas com prioridades.
                  </li>
                </ul>
              </Card>
            </AnimatedSection>
