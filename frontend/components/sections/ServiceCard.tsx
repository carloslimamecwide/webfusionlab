  ...
  return (
    <Card hover className={`h-full ${className}`}>
      <div className="flex items-start gap-4">
        ...
        <div>
          <h3 className="text-xl font-semibold mb-2 tracking-tight text-white">{service.title}</h3>
          <p className="text-white/60 text-sm leading-relaxed">{service.description}</p>
        </div>
      </div>
      {showFeatures && (
        <div className="border-t border-white/10 pt-4 mt-5">
          <h3 className="text-[10px] uppercase tracking-[0.3em] text-[color:var(--accent)] mb-3">O que entregamos</h3>
